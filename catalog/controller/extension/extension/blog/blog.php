...
class ControllerExtensionExtensionBlogBlog extends Controller
{
    public function index()
    {

        $this->load->model('extension/extension/blog/article');
        $this->load->language('extension/extension/blog/blog');
        ...
        if ($status) {
            ...
            $this->document->addLink($this->url->link('extension/extension/blog/blog'), '');
            ...
            foreach ($results as $result) {
                $data['articles'][] = array(
                    ...
                    'href' => $this->url->link('extension/extension/blog/article', 'article_id=' . $result['article_id'] . $url)
                );
            }
            ...
            $data['sorts'][] = array(
                ...
                'href' => $this->url->link('extension/extension/blog/blog', '&sort=p.sort_order&order=ASC' . $url)
            );
            ...
            foreach ($limits as $value) {
                $data['limits'][] = array(
                    'text' => $value,
                    'value' => $value,
                    'href' => $this->url->link('extension/extension/blog/blog', $url . '&limit=' . $value)
                );
            }
            ...
            $this->response->setOutput($this->load->view('extension/extension/blog/blog', $data));
            ...
            $data['breadcrumbs'][] = array(
                ...
                'href' => $this->url->link('extension/extension/blog/blog', $url)
            );
